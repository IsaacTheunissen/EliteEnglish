...
export default function Rates() {
  return (
    <section id="rates" className="py-20 bg-white relative overflow-hidden">
      <div className="absolute top-20 left-0 w-72 h-72 bg-[#1E88C7]/5 rounded-full blur-3xl floating"></div>
      <div className="absolute bottom-20 right-0 w-96 h-96 bg-[#2BA3DB]/5 rounded-full blur-3xl floating-delayed"></div>
      <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-[#4DC4EC]/3 rounded-full blur-3xl pulse-slow"></div>
